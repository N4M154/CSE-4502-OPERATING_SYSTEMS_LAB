...
00101796 <printnum>:
  ...
  1017e0:	e8 fb 1c 00 00       	call   1034e0 <__udivdi3>
  ...
  101833:	e8 c8 1d 00 00       	call   103600 <__umoddi3>
...
001025d9 <mon_kerninfo>:
  ...
  102619:	c7 c0 3f 37 10 00    	mov    $0x10373f,%eax
  10261f:	50                   	push   %eax
...
void kern_init(uintptr_t mbi_addr)
{
  ...
  102904:	e8 c7 06 00 00       	call   102fd0 <pmem_init>
  ...
  10293c:	e8 25 ee ff ff       	call   101766 <dprintf>
    if (test_MATIntro() == 0)
  102941:	e8 5a 06 00 00       	call   102fa0 <test_MATIntro>
  ...
  10297b:	e8 e6 ed ff ff       	call   101766 <dprintf>
    if (test_MATInit() == 0)
  102980:	e8 7b 08 00 00       	call   103200 <test_MATInit>
  ...
  1029b4:	e8 ad ed ff ff       	call   101766 <dprintf>
    if (test_MATOp() == 0)
  1029b9:	e8 02 0b 00 00       	call   1034c0 <test_MATOp>
...
int MATIntro_test_own()
{
  ...
  102f23:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
  102f2a:	e8 91 fb ff ff       	call   102ac0 <at_is_norm>
  102f2f:	83 c4 10             	add    $0x10,%esp
  102f32:	83 f8 01             	cmp    $0x1,%eax
  102f35:	75 12                	jne    102f49 <MATIntro_test_own+0x49>
  102f37:	83 ec 0c             	sub    $0xc,%esp
  102f3a:	6a 0a                	push   $0xa
  102f3c:	e8 cf fb ff ff       	call   102b10 <at_is_allocated>
  102f41:	83 c4 10             	add    $0x10,%esp
  102f44:	83 f8 01             	cmp    $0x1,%eax
  102f47:	74 1f                	je     102f68 <MATIntro_test_own+0x68>
    {
        dprintf("test own failed: Permission or allocation state mismatch\n");
  102f49:	83 ec 0c             	sub    $0xc,%esp
  102f4c:	8d 83 e4 d6 ff ff    	lea    -0x291c(%ebx),%eax
  102f52:	50                   	push   %eax
  102f53:	e8 0e e8 ff ff       	call   101766 <dprintf>
        return 1;
  102f58:	83 c4 10             	add    $0x10,%esp
  ...
  102f60:	83 c4 08             	add    $0x8,%esp
  102f63:	5b                   	pop    %ebx
  102f64:	c3                   	ret
  102f65:	8d 76 00             	lea    0x0(%esi),%esi
    at_set_perm(test_index, 0);
  102f68:	83 ec 08             	sub    $0x8,%esp
  102f6b:	6a 00                	push   $0x0
  102f6d:	6a 0a                	push   $0xa
  102f6f:	e8 6c fb ff ff       	call   102ae0 <at_set_perm>
    at_set_allocated(test_index, 0);
  102f74:	58                   	pop    %eax
  102f75:	5a                   	pop    %edx
  102f76:	6a 00                	push   $0x0
  102f78:	6a 0a                	push   $0xa
  102f7a:	e8 b1 fb ff ff       	call   102b30 <at_set_allocated>
    dprintf("own test passed.\n");
  102f7f:	8d 83 84 d5 ff ff    	lea    -0x2a7c(%ebx),%eax
  102f85:	89 04 24             	mov    %eax,(%esp)
  102f88:	e8 d9 e7 ff ff       	call   101766 <dprintf>
  102f8d:	83 c4 10             	add    $0x10,%esp
  102f90:	31 c0                	xor    %eax,%eax
}
  102f92:	83 c4 08             	add    $0x8,%esp
  102f95:	5b                   	pop    %ebx
  102f96:	c3                   	ret
  102f97:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
  102f9e:	00 
  102f9f:	90                   	nop

00102fa0 <test_MATIntro>:

int test_MATIntro()
{
  102fa0:	53                   	push   %ebx
  102fa1:	83 ec 08             	sub    $0x8,%esp
    return MATIntro_test1() + MATIntro_test2() + MATIntro_test3() + MATIntro_test_own();
  102fa4:	e8 a7 fb ff ff       	call   102b50 <MATIntro_test1>
  102fa9:	89 c3                	mov    %eax,%ebx
  102fab:	e8 90 fc ff ff       	call   102c40 <MATIntro_test2>
  102fb0:	01 c3                	add    %eax,%ebx
  102fb2:	e8 49 fe ff ff       	call   102e00 <MATIntro_test3>
  102fb7:	01 c3                	add    %eax,%ebx
  102fb9:	e8 42 ff ff ff       	call   102f00 <MATIntro_test_own>
}
  102fbe:	83 c4 08             	add    $0x8,%esp
    return MATIntro_test1() + MATIntro_test2() + MATIntro_test3() + MATIntro_test_own();
...
void pmem_init(unsigned int mbi_addr)
{
  ...
  102fd2:	56                   	push   %esi
  102fd3:	53                   	push   %ebx
  102fd4:	e8 e7 d3 ff ff       	call   1003c0 <__x86.get_pc_thunk.bx>
  102fd9:	81 c3 1b 40 00 00    	add    $0x401b,%ebx
  102fdf:	83 ec 38             	sub    $0x38,%esp
  unsigned int i;
  unsigned int j;
  ...
  devinit(mbi_addr);
  102fe2:	ff 74 24 4c          	push   0x4c(%esp)
  102fe6:	e8 16 db ff ff       	call   100b01 <devinit>
  ...
  102feb:	e8 5a e0 ff ff       	call   10104a <get_size>
  102ff0:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  if (table == 0)     // no memory region available
  102ff4:	83 c4 10             	add    $0x10,%esp
  102ff7:	85 c0                	test   %eax,%eax
  102ff9:	75 15                	jne    103010 <pmem_init+0x40>
  ...
  102ffb:	83 ec 0c             	sub    $0xc,%esp
  102ffe:	6a 00                	push   $0x0
  103000:	e8 9b fa ff ff       	call   102aa0 <set_nps>
  ...
  103010:	8b 44 24 0c          	mov    0xc(%esp),%eax
  103014:	83 ec 0c             	sub    $0xc,%esp
  103017:	8d 78 ff             	lea    -0x1(%eax),%edi
  10301a:	57                   	push   %edi
  10301b:	e8 3f e0 ff ff       	call   10105f <get_mms>
    length = get_mml(table - 1);      // lengt of the last row
  103020:	89 3c 24             	mov    %edi,(%esp)
    start_addrs = get_mms(table - 1); // start address of the last row.Because the last row has the most memory.
  103023:	89 c6                	mov    %eax,%esi
    length = get_mml(table - 1);      // lengt of the last row
  103025:	e8 9b e0 ff ff       	call   1010c5 <get_mml>
    end_addrs = start_addrs + length - 1;
  10302a:	01 c6                	add    %eax,%esi
    nps = (end_addrs + 1) / PAGESIZE; // to account for zero-based indexing.This gives the number of 4KB pages that can fit into the physical memory up to end_addrs.
  10302c:	c1 ee 0c             	shr    $0xc,%esi
  set_nps(nps); // Setting the value computed above to NUM_PAGES.
  10302f:	89 34 24             	mov    %esi,(%esp)
    nps = (end_addrs + 1) / PAGESIZE; // to account for zero-based indexing.This gives the number of 4KB pages that can fit into the physical memory up to end_addrs.
  103032:	89 f5                	mov    %esi,%ebp
  set_nps(nps); // Setting the value computed above to NUM_PAGES.
  103034:	e8 67 fa ff ff       	call   102aa0 <set_nps>
  for (i = 0; i < nps; i++)
  103039:	83 c4 10             	add    $0x10,%esp
  10303c:	85 f6                	test   %esi,%esi
  10303e:	74 c8                	je     103008 <pmem_init+0x38>
  103040:	31 ff                	xor    %edi,%edi
  103042:	eb 19                	jmp    10305d <pmem_init+0x8d>
  103044:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      at_set_perm(i, 1);
  103048:	83 ec 08             	sub    $0x8,%esp
  10304b:	6a 01                	push   $0x1
  10304d:	57                   	push   %edi
  10304e:	e8 8d fa ff ff       	call   102ae0 <at_set_perm>
  103053:	83 c4 10             	add    $0x10,%esp
  for (i = 0; i < nps; i++)
  103056:	83 c7 01             	add    $0x1,%edi
  103059:	39 fd                	cmp    %edi,%ebp
  10305b:	74 ab                	je     103008 <pmem_init+0x38>
    if (i < VM_USERLO_PI || i >= VM_USERHI_PI)
  10305d:	8d 87 00 00 fc ff    	lea    -0x40000(%edi),%eax
  103063:	3d ff ff 0a 00       	cmp    $0xaffff,%eax
  103068:	77 de                	ja     103048 <pmem_init+0x78>
  10306a:	89 fa                	mov    %edi,%edx
      for (j = 0; j < table; j++)
  10306c:	89 6c 24 18          	mov    %ebp,0x18(%esp)
  103070:	31 f6                	xor    %esi,%esi
  103072:	c1 e2 0c             	shl    $0xc,%edx
  103075:	89 7c 24 1c          	mov    %edi,0x1c(%esp)
  103079:	8d 82 ff 0f 00 00    	lea    0xfff(%edx),%eax
  10307f:	89 54 24 14          	mov    %edx,0x14(%esp)
  103083:	89 44 24 10          	mov    %eax,0x10(%esp)
  103087:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
  10308e:	00 
  10308f:	90                   	nop
        start_addrs = get_mms(j);
  103090:	83 ec 0c             	sub    $0xc,%esp
  103093:	56                   	push   %esi
  103094:	e8 c6 df ff ff       	call   10105f <get_mms>
        length = get_mml(j);
  103099:	89 34 24             	mov    %esi,(%esp)
        start_addrs = get_mms(j);
  10309c:	89 c7                	mov    %eax,%edi
        length = get_mml(j);
  10309e:	e8 22 e0 ff ff       	call   1010c5 <get_mml>
        if (is_usable(j))
  1030a3:	89 34 24             	mov    %esi,(%esp)
        length = get_mml(j);
  1030a6:	89 c5                	mov    %eax,%ebp
        if (is_usable(j))
  1030a8:	e8 88 e0 ff ff       	call   101135 <is_usable>
  1030ad:	83 c4 10             	add    $0x10,%esp
  1030b0:	85 c0                	test   %eax,%eax
  1030b2:	74 10                	je     1030c4 <pmem_init+0xf4>
        end_addrs = start_addrs + length - 1;
  1030b4:	8d 44 2f ff          	lea    -0x1(%edi,%ebp,1),%eax
          if (page_start >= start_addrs && page_end < end_addrs)
  1030b8:	39 44 24 10          	cmp    %eax,0x10(%esp)
  1030bc:	73 06                	jae    1030c4 <pmem_init+0xf4>
  1030be:	39 7c 24 14          	cmp    %edi,0x14(%esp)
  1030c2:	73 2c                	jae    1030f0 <pmem_init+0x120>
      for (j = 0; j < table; j++)
  1030c4:	83 c6 01             	add    $0x1,%esi
  1030c7:	39 74 24 0c          	cmp    %esi,0xc(%esp)
  1030cb:	75 c3                	jne    103090 <pmem_init+0xc0>
      perm = 0; // Assume the page is unusable (default).
  1030cd:	8b 6c 24 18          	mov    0x18(%esp),%ebp
  1030d1:	8b 7c 24 1c          	mov    0x1c(%esp),%edi
  1030d5:	31 c0                	xor    %eax,%eax
      at_set_perm(i, perm); // Set permission
  1030d7:	83 ec 08             	sub    $0x8,%esp
  1030da:	50                   	push   %eax
  1030db:	57                   	push   %edi
  1030dc:	e8 ff f9 ff ff       	call   102ae0 <at_set_perm>
  1030e1:	83 c4 10             	add    $0x10,%esp
  1030e4:	e9 6d ff ff ff       	jmp    103056 <pmem_init+0x86>
  1030e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
            perm = 2; // Mark the page as usable.
  1030f0:	8b 6c 24 18          	mov    0x18(%esp),%ebp
  1030f4:	8b 7c 24 1c          	mov    0x1c(%esp),%edi
  1030f8:	b8 02 00 00 00       	mov    $0x2,%eax
  1030fd:	eb d8                	jmp    1030d7 <pmem_init+0x107>
  1030ff:	90                   	nop

00103100 <MATInit_test1>:
...
int MATInit_test1()
{
  103100:	57                   	push   %edi
  103101:	56                   	push   %esi
  103102:	31 f6                	xor    %esi,%esi
  103104:	53                   	push   %ebx
  103105:	e8 b6 d2 ff ff       	call   1003c0 <__x86.get_pc_thunk.bx>
  10310a:	81 c3 ea 3e 00 00    	add    $0x3eea,%ebx
    int i;
    int nps = get_nps();
  103110:	e8 6b f9 ff ff       	call   102a80 <get_nps>
  103115:	89 c7                	mov    %eax,%edi
    if (nps <= 1000)
  103117:	3d e8 03 00 00       	cmp    $0x3e8,%eax
  10311c:	7f 11                	jg     10312f <MATInit_test1+0x2f>
  10311e:	e9 ad 00 00 00       	jmp    1031d0 <MATInit_test1+0xd0>
  103123:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    {
        dprintf("test 1.1 failed: (%d <= 1000)\n", nps);
        return 1;
    }
    for (i = 0; i < nps; i++)
  103128:	83 c6 01             	add    $0x1,%esi
  10312b:	39 f7                	cmp    %esi,%edi
  10312d:	74 51                	je     103180 <MATInit_test1+0x80>
    {
        if (at_is_allocated(i) != 0)
  10312f:	83 ec 0c             	sub    $0xc,%esp
  103132:	56                   	push   %esi
  103133:	e8 d8 f9 ff ff       	call   102b10 <at_is_allocated>
  103138:	83 c4 10             	add    $0x10,%esp
  10313b:	85 c0                	test   %eax,%eax
  10313d:	75 61                	jne    1031a0 <MATInit_test1+0xa0>
        {
            dprintf("test 1.2 failed (i = %d): (%d != 0)\n", i, at_is_allocated(i));
            return 1;
        }
        if ((i < VM_USERLO_PI || VM_USERHI_PI <= i) && at_is_norm(i) != 0)
  10313f:	8d 86 00 00 fc ff    	lea    -0x40000(%esi),%eax
  103145:	3d ff ff 0a 00       	cmp    $0xaffff,%eax
  10314a:	76 dc                	jbe    103128 <MATInit_test1+0x28>
  10314c:	83 ec 0c             	sub    $0xc,%esp
  10314f:	56                   	push   %esi
  103150:	e8 6b f9 ff ff       	call   102ac0 <at_is_norm>
  103155:	83 c4 10             	add    $0x10,%esp
  103158:	85 c0                	test   %eax,%eax
  10315a:	74 cc                	je     103128 <MATInit_test1+0x28>
        {
            dprintf("test 1.3 failed (i = %d): (%d != 0)\n", i, at_is_norm(i));
  10315c:	83 ec 0c             	sub    $0xc,%esp
  10315f:	56                   	push   %esi
  103160:	e8 5b f9 ff ff       	call   102ac0 <at_is_norm>
  103165:	83 c4 0c             	add    $0xc,%esp
  103168:	50                   	push   %eax
  103169:	8d 83 68 d7 ff ff    	lea    -0x2898(%ebx),%eax
  10316f:	56                   	push   %esi
  103170:	50                   	push   %eax
  103171:	e8 f0 e5 ff ff       	call   101766 <dprintf>
            return 1;
  103176:	83 c4 10             	add    $0x10,%esp
  103179:	eb 42                	jmp    1031bd <MATInit_test1+0xbd>
  10317b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        }
    }
    dprintf("test 1 passed.\n");
  103180:	83 ec 0c             	sub    $0xc,%esp
  103183:	8d 83 00 d5 ff ff    	lea    -0x2b00(%ebx),%eax
  103189:	50                   	push   %eax
  10318a:	e8 d7 e5 ff ff       	call   101766 <dprintf>
    return 0;
  10318f:	83 c4 10             	add    $0x10,%esp
  103192:	31 c0                	xor    %eax,%eax
}
  103194:	5b                   	pop    %ebx
  103195:	5e                   	pop    %esi
  103196:	5f                   	pop    %edi
  103197:	c3                   	ret
  103198:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
  10319f:	00 
            dprintf("test 1.2 failed (i = %d): (%d != 0)\n", i, at_is_allocated(i));
  1031a0:	83 ec 0c             	sub    $0xc,%esp
  1031a3:	56                   	push   %esi
  1031a4:	e8 67 f9 ff ff       	call   102b10 <at_is_allocated>
  1031a9:	83 c4 0c             	add    $0xc,%esp
  1031ac:	50                   	push   %eax
  1031ad:	8d 83 40 d7 ff ff    	lea    -0x28c0(%ebx),%eax
  1031b3:	56                   	push   %esi
  1031b4:	50                   	push   %eax
  1031b5:	e8 ac e5 ff ff       	call   101766 <dprintf>
            return 1;
  1031ba:	83 c4 10             	add    $0x10,%esp
}
  1031bd:	5b                   	pop    %ebx
        return 1;
  1031be:	b8 01 00 00 00       	mov    $0x1,%eax
}
  1031c3:	5e                   	pop    %esi
  1031c4:	5f                   	pop    %edi
  1031c5:	c3                   	ret
  1031c6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
  1031cd:	00 
  1031ce:	66 90                	xchg   %ax,%ax
        dprintf("test 1.1 failed: (%d <= 1000)\n", nps);
  1031d0:	83 ec 08             	sub    $0x8,%esp
  1031d3:	50                   	push   %eax
  1031d4:	8d 83 20 d7 ff ff    	lea    -0x28e0(%ebx),%eax
  1031da:	50                   	push   %eax
  1031db:	e8 86 e5 ff ff       	call   101766 <dprintf>
        return 1;
  1031e0:	83 c4 10             	add    $0x10,%esp
  1031e3:	eb d8                	jmp    1031bd <MATInit_test1+0xbd>
  1031e5:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
  1031ec:	00 
  1031ed:	8d 76 00             	lea    0x0(%esi),%esi

001031f0 <MATInit_test_own>:
{
    // TODO (optional)
  ...
  1031f0:	31 c0                	xor    %eax,%eax
  1031f2:	c3                   	ret
  1031f3:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
  1031fa:	00 
  1031fb:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi

00103200 <test_MATInit>:

int test_MATInit()
{
    return MATInit_test1() + MATInit_test_own();
  103200:	e9 fb fe ff ff       	jmp    103100 <MATInit_test1>
  103205:	66 90                	xchg   %ax,%ax
  103207:	66 90                	xchg   %ax,%ax
  103209:	66 90                	xchg   %ax,%ax
  10320b:	66 90                	xchg   %ax,%ax
  10320d:	66 90                	xchg   %ax,%ax
  10320f:	90                   	nop
...
unsigned int palloc()
{
  103210:	56                   	push   %esi
  103211:	53                   	push   %ebx
  103212:	e8 a9 d1 ff ff       	call   1003c0 <__x86.get_pc_thunk.bx>
  103217:	81 c3 dd 3d 00 00    	add    $0x3ddd,%ebx
  10321d:	83 ec 04             	sub    $0x4,%esp
  // TODO - DONE
  // no available physical pages
  if (get_nps() == 0)
  103220:	e8 5b f8 ff ff       	call   102a80 <get_nps>
  103225:	85 c0                	test   %eax,%eax
  103227:	74 77                	je     1032a0 <palloc+0x90>
    return 0;
  }
  ...
  103229:	8b b3 34 05 00 00    	mov    0x534(%ebx),%esi
  10322f:	89 f0                	mov    %esi,%eax
  103231:	eb 28                	jmp    10325b <palloc+0x4b>
  103233:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    ...
    next++;
  103238:	8b 93 34 05 00 00    	mov    0x534(%ebx),%edx
    // if next moves to the end, we set next to the beginning
    if (next == VM_USERHI_PI)
  10323e:	b9 00 00 04 00       	mov    $0x40000,%ecx
    next++;
  103243:	8d 42 01             	lea    0x1(%edx),%eax
    if (next == VM_USERHI_PI)
  103246:	81 fa ff ff 0e 00    	cmp    $0xeffff,%edx
  10324c:	0f 45 c8             	cmovne %eax,%ecx
    next++;
  10324f:	89 8b 34 05 00 00    	mov    %ecx,0x534(%ebx)
    if (next == VM_USERHI_PI)
  103255:	89 c8                	mov    %ecx,%eax
    {
      next = VM_USERLO_PI;
    }
  } while (next != start);
  103257:	39 ce                	cmp    %ecx,%esi
  103259:	74 45                	je     1032a0 <palloc+0x90>
    if (at_is_norm(next) && at_is_allocated(next) == 0)
  10325b:	83 ec 0c             	sub    $0xc,%esp
  10325e:	50                   	push   %eax
  10325f:	e8 5c f8 ff ff       	call   102ac0 <at_is_norm>
  103264:	83 c4 10             	add    $0x10,%esp
  103267:	85 c0                	test   %eax,%eax
  103269:	74 cd                	je     103238 <palloc+0x28>
  10326b:	83 ec 0c             	sub    $0xc,%esp
  10326e:	ff b3 34 05 00 00    	push   0x534(%ebx)
  103274:	e8 97 f8 ff ff       	call   102b10 <at_is_allocated>
  103279:	83 c4 10             	add    $0x10,%esp
  10327c:	85 c0                	test   %eax,%eax
  10327e:	75 b8                	jne    103238 <palloc+0x28>
      at_set_allocated(next, 1);
  103280:	83 ec 08             	sub    $0x8,%esp
  103283:	6a 01                	push   $0x1
  103285:	ff b3 34 05 00 00    	push   0x534(%ebx)
  10328b:	e8 a0 f8 ff ff       	call   102b30 <at_set_allocated>
      return next;
  103290:	83 c4 10             	add    $0x10,%esp
  103293:	8b 83 34 05 00 00    	mov    0x534(%ebx),%eax

  // all pages are allocated
  return 0;
}
  103299:	83 c4 04             	add    $0x4,%esp
  10329c:	5b                   	pop    %ebx
  10329d:	5e                   	pop    %esi
  10329e:	c3                   	ret
  10329f:	90                   	nop
  1032a0:	83 c4 04             	add    $0x4,%esp
    return 0;
  ...
  1032a6:	5e                   	pop    %esi
  1032a7:	c3                   	ret
  1032a8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
  1032af:	00 
...
{
  1032b0:	53                   	push   %ebx
  1032b1:	e8 0a d1 ff ff       	call   1003c0 <__x86.get_pc_thunk.bx>
  1032b6:	81 c3 3e 3d 00 00    	add    $0x3d3e,%ebx
  1032bc:	83 ec 10             	sub    $0x10,%esp
  // TODO - DONE
  at_set_allocated(pfree_index, 0); // from MATIntro.c
  1032bf:	6a 00                	push   $0x0
  1032c1:	ff 74 24 1c          	push   0x1c(%esp)
  1032c5:	e8 66 f8 ff ff       	call   102b30 <at_set_allocated>
}
  1032ca:	83 c4 18             	add    $0x18,%esp
  1032cd:	5b                   	pop    %ebx
  1032ce:	c3                   	ret
  1032cf:	90                   	nop

001032d0 <MATOp_test1>:
#define VM_USERHI 0xF0000000
#define VM_USERLO_PI (VM_USERLO / PAGESIZE)
#define VM_USERHI_PI (VM_USERHI / PAGESIZE)
...
int MATOp_test1()
{
  1032d0:	56                   	push   %esi
  1032d1:	53                   	push   %ebx
  1032d2:	e8 e9 d0 ff ff       	call   1003c0 <__x86.get_pc_thunk.bx>
  1032d7:	81 c3 1d 3d 00 00    	add    $0x3d1d,%ebx
  1032dd:	83 ec 04             	sub    $0x4,%esp
    int page_index = palloc();
  1032e0:	e8 2b ff ff ff       	call   103210 <palloc>
  1032e5:	89 c6                	mov    %eax,%esi
    if (page_index < VM_USERLO_PI || VM_USERHI_PI <= page_index)
  1032e7:	2d 00 00 04 00       	sub    $0x40000,%eax
  1032ec:	3d ff ff 0a 00       	cmp    $0xaffff,%eax
  1032f1:	0f 87 91 00 00 00    	ja     103388 <MATOp_test1+0xb8>
    {
  ...
  1032f7:	83 ec 0c             	sub    $0xc,%esp
  1032fa:	56                   	push   %esi
  1032fb:	e8 c0 f7 ff ff       	call   102ac0 <at_is_norm>
  103300:	83 c4 10             	add    $0x10,%esp
  103303:	83 f8 01             	cmp    $0x1,%eax
  103306:	74 38                	je     103340 <MATOp_test1+0x70>
    {
        dprintf("test 1.2 failed: (%d != 1)\n", at_is_norm(page_index));
  103308:	83 ec 0c             	sub    $0xc,%esp
  10330b:	56                   	push   %esi
  10330c:	e8 af f7 ff ff       	call   102ac0 <at_is_norm>
  103311:	5a                   	pop    %edx
  103312:	59                   	pop    %ecx
  103313:	50                   	push   %eax
  103314:	8d 83 96 d5 ff ff    	lea    -0x2a6a(%ebx),%eax
  10331a:	50                   	push   %eax
  10331b:	e8 46 e4 ff ff       	call   101766 <dprintf>
        pfree(page_index);
  103320:	89 34 24             	mov    %esi,(%esp)
  103323:	e8 88 ff ff ff       	call   1032b0 <pfree>
        return 1;
  ...
  10332b:	83 c4 04             	add    $0x4,%esp
        return 1;
  10332e:	b8 01 00 00 00       	mov    $0x1,%eax
}
  103333:	5b                   	pop    %ebx
  103334:	5e                   	pop    %esi
  103335:	c3                   	ret
  103336:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
  10333d:	00 
  10333e:	66 90                	xchg   %ax,%ax
    if (at_is_allocated(page_index) != 1)
  103340:	83 ec 0c             	sub    $0xc,%esp
  103343:	56                   	push   %esi
  103344:	e8 c7 f7 ff ff       	call   102b10 <at_is_allocated>
  103349:	83 c4 10             	add    $0x10,%esp
  10334c:	83 f8 01             	cmp    $0x1,%eax
  10334f:	75 47                	jne    103398 <MATOp_test1+0xc8>
    pfree(page_index);
  103351:	83 ec 0c             	sub    $0xc,%esp
  103354:	56                   	push   %esi
  103355:	e8 56 ff ff ff       	call   1032b0 <pfree>
    if (at_is_allocated(page_index) != 0)
  10335a:	89 34 24             	mov    %esi,(%esp)
  10335d:	e8 ae f7 ff ff       	call   102b10 <at_is_allocated>
  103362:	83 c4 10             	add    $0x10,%esp
  103365:	85 c0                	test   %eax,%eax
  103367:	75 47                	jne    1033b0 <MATOp_test1+0xe0>
    dprintf("test 1 passed.\n");
  103369:	83 ec 0c             	sub    $0xc,%esp
  10336c:	8d 83 00 d5 ff ff    	lea    -0x2b00(%ebx),%eax
  103372:	50                   	push   %eax
  103373:	e8 ee e3 ff ff       	call   101766 <dprintf>
    return 0;
  103378:	83 c4 10             	add    $0x10,%esp
  10337b:	31 c0                	xor    %eax,%eax
}
  10337d:	83 c4 04             	add    $0x4,%esp
  103380:	5b                   	pop    %ebx
  103381:	5e                   	pop    %esi
  103382:	c3                   	ret
  103383:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        dprintf("test 1.1 failed: (%d < VM_USERLO_PI || VM_USERHI_PI <= %d)\n", page_index, page_index);
  103388:	83 ec 04             	sub    $0x4,%esp
  10338b:	8d 83 90 d7 ff ff    	lea    -0x2870(%ebx),%eax
  103391:	56                   	push   %esi
  103392:	56                   	push   %esi
  103393:	eb 85                	jmp    10331a <MATOp_test1+0x4a>
  103395:	8d 76 00             	lea    0x0(%esi),%esi
        dprintf("test 1.3 failed: (%d != 1)\n", at_is_allocated(page_index));
  103398:	83 ec 0c             	sub    $0xc,%esp
  10339b:	56                   	push   %esi
  10339c:	e8 6f f7 ff ff       	call   102b10 <at_is_allocated>
  1033a1:	5a                   	pop    %edx
  1033a2:	59                   	pop    %ecx
  1033a3:	50                   	push   %eax
  1033a4:	8d 83 b2 d5 ff ff    	lea    -0x2a4e(%ebx),%eax
  1033aa:	e9 6b ff ff ff       	jmp    10331a <MATOp_test1+0x4a>
  1033af:	90                   	nop
        dprintf("test 1.4 failed: (%d != 0)\n", at_is_allocated(page_index));
  1033b0:	83 ec 0c             	sub    $0xc,%esp
  1033b3:	56                   	push   %esi
  1033b4:	e8 57 f7 ff ff       	call   102b10 <at_is_allocated>
  1033b9:	5a                   	pop    %edx
  1033ba:	59                   	pop    %ecx
  1033bb:	50                   	push   %eax
  1033bc:	8d 83 ce d5 ff ff    	lea    -0x2a32(%ebx),%eax
  1033c2:	50                   	push   %eax
  1033c3:	e8 9e e3 ff ff       	call   101766 <dprintf>
        return 1;
  1033c8:	83 c4 10             	add    $0x10,%esp
  1033cb:	e9 5b ff ff ff       	jmp    10332b <MATOp_test1+0x5b>

001033d0 <MATOp_test_own>:
 * Be extra careful to make sure that if you overwrite some of the kernel data, they are set back to
 * the original value. O.w., it may make the future test scripts to fail even if you implement all
 * the functions correctly.
 */
int MATOp_test_own()
{
  ...
  1033d1:	bf 0a 00 00 00       	mov    $0xa,%edi
{
  1033d6:	56                   	push   %esi
  1033d7:	53                   	push   %ebx
  1033d8:	e8 e3 cf ff ff       	call   1003c0 <__x86.get_pc_thunk.bx>
  1033dd:	81 c3 17 3c 00 00    	add    $0x3c17,%ebx
    int nps = get_nps(); // Get the number of physical pages
  1033e3:	e8 98 f6 ff ff       	call   102a80 <get_nps>
  ...
  1033f0:	e8 1b fe ff ff       	call   103210 <palloc>
  1033f5:	89 c6                	mov    %eax,%esi
        if (page_index == 0)
  1033f7:	85 c0                	test   %eax,%eax
  1033f9:	74 65                	je     103460 <MATOp_test_own+0x90>
        {
            dprintf("Test failed: palloc returned 0, no pages available\n");
            return 2; // Fail
        }
        if (at_is_allocated(page_index) != 1)
  1033fb:	83 ec 0c             	sub    $0xc,%esp
  1033fe:	50                   	push   %eax
  1033ff:	e8 0c f7 ff ff       	call   102b10 <at_is_allocated>
  103404:	83 c4 10             	add    $0x10,%esp
  103407:	83 f8 01             	cmp    $0x1,%eax
  10340a:	0f 85 90 00 00 00    	jne    1034a0 <MATOp_test_own+0xd0>
    for (i = 0; i < 10; i++)
  103410:	83 ef 01             	sub    $0x1,%edi
  103413:	75 db                	jne    1033f0 <MATOp_test_own+0x20>
    ...
    for (i = 0; i < 10; i++)
  103415:	31 f6                	xor    %esi,%esi
  103417:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
  10341e:	00 
  10341f:	90                   	nop
    {
  ...
  103423:	56                   	push   %esi
  103424:	e8 87 fe ff ff       	call   1032b0 <pfree>
        if (at_is_allocated(page_index) != 0)
  103429:	89 34 24             	mov    %esi,(%esp)
  10342c:	e8 df f6 ff ff       	call   102b10 <at_is_allocated>
  103431:	83 c4 10             	add    $0x10,%esp
  103434:	85 c0                	test   %eax,%eax
  103436:	75 48                	jne    103480 <MATOp_test_own+0xb0>
    for (i = 0; i < 10; i++)
  103438:	83 c6 01             	add    $0x1,%esi
  10343b:	83 fe 0a             	cmp    $0xa,%esi
  10343e:	75 e0                	jne    103420 <MATOp_test_own+0x50>
  ...
  103443:	8d 83 ea d5 ff ff    	lea    -0x2a16(%ebx),%eax
  103449:	50                   	push   %eax
  10344a:	e8 17 e3 ff ff       	call   101766 <dprintf>
    return 0; // Success
  10344f:	83 c4 10             	add    $0x10,%esp
  103452:	31 c0                	xor    %eax,%eax
}
  103454:	5b                   	pop    %ebx
  103455:	5e                   	pop    %esi
  103456:	5f                   	pop    %edi
  ...
  10345f:	00 
            dprintf("Test failed: palloc returned 0, no pages available\n");
  103460:	83 ec 0c             	sub    $0xc,%esp
  103463:	8d 83 cc d7 ff ff    	lea    -0x2834(%ebx),%eax
  103469:	50                   	push   %eax
  10346a:	e8 f7 e2 ff ff       	call   101766 <dprintf>
            return 2; // Fail
  10346f:	83 c4 10             	add    $0x10,%esp
}
  103472:	5b                   	pop    %ebx
            return 2; // Fail
  103473:	b8 02 00 00 00       	mov    $0x2,%eax
}
  103478:	5e                   	pop    %esi
  103479:	5f                   	pop    %edi
  10347a:	c3                   	ret
  10347b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
            dprintf("Test ailed at page %d: Page should be unallocated but is still allocated\n", page_index);
  103480:	83 ec 08             	sub    $0x8,%esp
  103483:	8d 83 40 d8 ff ff    	lea    -0x27c0(%ebx),%eax
  103489:	56                   	push   %esi
  10348a:	50                   	push   %eax
  10348b:	e8 d6 e2 ff ff       	call   101766 <dprintf>
            return 3; // Fail
  103490:	83 c4 10             	add    $0x10,%esp
  103493:	b8 03 00 00 00       	mov    $0x3,%eax
}
  103498:	5b                   	pop    %ebx
  103499:	5e                   	pop    %esi
  10349a:	5f                   	pop    %edi
  ...
  10349c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
            dprintf("Test failed at page %d: Page should be allocated but is not\n", page_index);
  1034a0:	83 ec 08             	sub    $0x8,%esp
  1034a3:	8d 83 00 d8 ff ff    	lea    -0x2800(%ebx),%eax
  1034a9:	56                   	push   %esi
  1034aa:	50                   	push   %eax
  1034ab:	e8 b6 e2 ff ff       	call   101766 <dprintf>
            return 2; // Fail
  1034b0:	83 c4 10             	add    $0x10,%esp
  1034b3:	eb bd                	jmp    103472 <MATOp_test_own+0xa2>
  1034b5:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
  1034bc:	00 
  1034bd:	8d 76 00             	lea    0x0(%esi),%esi
...
int test_MATOp()
{
  ...
  1034c4:	e8 07 fe ff ff       	call   1032d0 <MATOp_test1>
  1034c9:	89 c3                	mov    %eax,%ebx
  1034cb:	e8 00 ff ff ff       	call   1033d0 <MATOp_test_own>
}
  1034d0:	83 c4 08             	add    $0x8,%esp
    return MATOp_test1() + MATOp_test_own();
  1034d3:	01 d8                	add    %ebx,%eax
}
  1034d5:	5b                   	pop    %ebx
  1034d6:	c3                   	ret
  1034d7:	66 90                	xchg   %ax,%ax
  1034d9:	66 90                	xchg   %ax,%ax
  1034db:	66 90                	xchg   %ax,%ax
  1034dd:	66 90                	xchg   %ax,%ax
  1034df:	90                   	nop

001034e0 <__udivdi3>:
  1034e0:	f3 0f 1e fb          	endbr32
  1034e4:	55                   	push   %ebp
  1034e5:	57                   	push   %edi
  1034e6:	56                   	push   %esi
  1034e7:	53                   	push   %ebx
  1034e8:	83 ec 1c             	sub    $0x1c,%esp
  1034eb:	8b 44 24 3c          	mov    0x3c(%esp),%eax
  1034ef:	8b 6c 24 30          	mov    0x30(%esp),%ebp
  1034f3:	8b 74 24 34          	mov    0x34(%esp),%esi
  1034f7:	8b 5c 24 38          	mov    0x38(%esp),%ebx
  1034fb:	85 c0                	test   %eax,%eax
  1034fd:	75 19                	jne    103518 <__udivdi3+0x38>
  1034ff:	39 de                	cmp    %ebx,%esi
  103501:	73 4d                	jae    103550 <__udivdi3+0x70>
  103503:	31 ff                	xor    %edi,%edi
  103505:	89 e8                	mov    %ebp,%eax
  103507:	89 f2                	mov    %esi,%edx
  103509:	f7 f3                	div    %ebx
  10350b:	89 fa                	mov    %edi,%edx
  10350d:	83 c4 1c             	add    $0x1c,%esp
  103510:	5b                   	pop    %ebx
  103511:	5e                   	pop    %esi
  103512:	5f                   	pop    %edi
  103513:	5d                   	pop    %ebp
  ...
  103518:	39 c6                	cmp    %eax,%esi
  10351a:	73 14                	jae    103530 <__udivdi3+0x50>
  10351c:	31 ff                	xor    %edi,%edi
  10351e:	31 c0                	xor    %eax,%eax
  103520:	89 fa                	mov    %edi,%edx
  103522:	83 c4 1c             	add    $0x1c,%esp
  103525:	5b                   	pop    %ebx
  103526:	5e                   	pop    %esi
  103527:	5f                   	pop    %edi
  103528:	5d                   	pop    %ebp
  ...
  103530:	0f bd f8             	bsr    %eax,%edi
  103533:	83 f7 1f             	xor    $0x1f,%edi
  103536:	75 48                	jne    103580 <__udivdi3+0xa0>
  103538:	39 f0                	cmp    %esi,%eax
  10353a:	72 06                	jb     103542 <__udivdi3+0x62>
  10353c:	31 c0                	xor    %eax,%eax
  10353e:	39 dd                	cmp    %ebx,%ebp
  103540:	72 de                	jb     103520 <__udivdi3+0x40>
  103542:	b8 01 00 00 00       	mov    $0x1,%eax
  103547:	eb d7                	jmp    103520 <__udivdi3+0x40>
  103549:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  103550:	89 d9                	mov    %ebx,%ecx
  103552:	85 db                	test   %ebx,%ebx
  103554:	75 0b                	jne    103561 <__udivdi3+0x81>
  103556:	b8 01 00 00 00       	mov    $0x1,%eax
  10355b:	31 d2                	xor    %edx,%edx
  10355d:	f7 f3                	div    %ebx
  10355f:	89 c1                	mov    %eax,%ecx
  103561:	31 d2                	xor    %edx,%edx
  103563:	89 f0                	mov    %esi,%eax
  103565:	f7 f1                	div    %ecx
  103567:	89 c6                	mov    %eax,%esi
  103569:	89 e8                	mov    %ebp,%eax
  10356b:	89 f7                	mov    %esi,%edi
  10356d:	f7 f1                	div    %ecx
  10356f:	89 fa                	mov    %edi,%edx
  103571:	83 c4 1c             	add    $0x1c,%esp
  103574:	5b                   	pop    %ebx
  103575:	5e                   	pop    %esi
  103576:	5f                   	pop    %edi
  103577:	5d                   	pop    %ebp
  ...
  103580:	89 f9                	mov    %edi,%ecx
  103582:	ba 20 00 00 00       	mov    $0x20,%edx
  103587:	29 fa                	sub    %edi,%edx
  103589:	d3 e0                	shl    %cl,%eax
  10358b:	89 44 24 08          	mov    %eax,0x8(%esp)
  10358f:	89 d1                	mov    %edx,%ecx
  103591:	89 d8                	mov    %ebx,%eax
  103593:	d3 e8                	shr    %cl,%eax
  103595:	89 c1                	mov    %eax,%ecx
  103597:	8b 44 24 08          	mov    0x8(%esp),%eax
  10359b:	09 c1                	or     %eax,%ecx
  10359d:	89 f0                	mov    %esi,%eax
  10359f:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  1035a3:	89 f9                	mov    %edi,%ecx
  1035a5:	d3 e3                	shl    %cl,%ebx
  1035a7:	89 d1                	mov    %edx,%ecx
  1035a9:	d3 e8                	shr    %cl,%eax
  1035ab:	89 f9                	mov    %edi,%ecx
  1035ad:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  1035b1:	89 eb                	mov    %ebp,%ebx
  1035b3:	d3 e6                	shl    %cl,%esi
  1035b5:	89 d1                	mov    %edx,%ecx
  1035b7:	d3 eb                	shr    %cl,%ebx
  1035b9:	09 f3                	or     %esi,%ebx
  1035bb:	89 c6                	mov    %eax,%esi
  1035bd:	89 f2                	mov    %esi,%edx
  1035bf:	89 d8                	mov    %ebx,%eax
  1035c1:	f7 74 24 08          	divl   0x8(%esp)
  1035c5:	89 d6                	mov    %edx,%esi
  1035c7:	89 c3                	mov    %eax,%ebx
  1035c9:	f7 64 24 0c          	mull   0xc(%esp)
  1035cd:	39 d6                	cmp    %edx,%esi
  1035cf:	72 1f                	jb     1035f0 <__udivdi3+0x110>
  1035d1:	89 f9                	mov    %edi,%ecx
  1035d3:	d3 e5                	shl    %cl,%ebp
  1035d5:	39 c5                	cmp    %eax,%ebp
  1035d7:	73 04                	jae    1035dd <__udivdi3+0xfd>
  1035d9:	39 d6                	cmp    %edx,%esi
  1035db:	74 13                	je     1035f0 <__udivdi3+0x110>
  1035dd:	89 d8                	mov    %ebx,%eax
  1035df:	31 ff                	xor    %edi,%edi
  1035e1:	e9 3a ff ff ff       	jmp    103520 <__udivdi3+0x40>
  1035e6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
  1035ed:	00 
  1035ee:	66 90                	xchg   %ax,%ax
  1035f0:	8d 43 ff             	lea    -0x1(%ebx),%eax
  1035f3:	31 ff                	xor    %edi,%edi
  1035f5:	e9 26 ff ff ff       	jmp    103520 <__udivdi3+0x40>
  1035fa:	66 90                	xchg   %ax,%ax
  1035fc:	66 90                	xchg   %ax,%ax
  1035fe:	66 90                	xchg   %ax,%ax

00103600 <__umoddi3>:
  103600:	f3 0f 1e fb          	endbr32
  103604:	55                   	push   %ebp
  103605:	57                   	push   %edi
  103606:	56                   	push   %esi
  103607:	53                   	push   %ebx
  103608:	83 ec 1c             	sub    $0x1c,%esp
  10360b:	8b 5c 24 34          	mov    0x34(%esp),%ebx
  10360f:	8b 44 24 3c          	mov    0x3c(%esp),%eax
  103613:	8b 74 24 30          	mov    0x30(%esp),%esi
  103617:	8b 7c 24 38          	mov    0x38(%esp),%edi
  10361b:	89 da                	mov    %ebx,%edx
  10361d:	85 c0                	test   %eax,%eax
  10361f:	75 17                	jne    103638 <__umoddi3+0x38>
  103621:	39 fb                	cmp    %edi,%ebx
  103623:	73 53                	jae    103678 <__umoddi3+0x78>
  103625:	89 f0                	mov    %esi,%eax
  103627:	f7 f7                	div    %edi
  103629:	89 d0                	mov    %edx,%eax
  10362b:	31 d2                	xor    %edx,%edx
  10362d:	83 c4 1c             	add    $0x1c,%esp
  103630:	5b                   	pop    %ebx
  103631:	5e                   	pop    %esi
  103632:	5f                   	pop    %edi
  103633:	5d                   	pop    %ebp
  ...
  103638:	89 f1                	mov    %esi,%ecx
  10363a:	39 c3                	cmp    %eax,%ebx
  10363c:	73 12                	jae    103650 <__umoddi3+0x50>
  10363e:	89 f0                	mov    %esi,%eax
  103640:	83 c4 1c             	add    $0x1c,%esp
  103643:	5b                   	pop    %ebx
  103644:	5e                   	pop    %esi
  103645:	5f                   	pop    %edi
  103646:	5d                   	pop    %ebp
  103647:	c3                   	ret
  103648:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
  10364f:	00 
  103650:	0f bd e8             	bsr    %eax,%ebp
  103653:	83 f5 1f             	xor    $0x1f,%ebp
  103656:	75 48                	jne    1036a0 <__umoddi3+0xa0>
  103658:	39 d8                	cmp    %ebx,%eax
  10365a:	0f 82 d0 00 00 00    	jb     103730 <__umoddi3+0x130>
  103660:	39 fe                	cmp    %edi,%esi
  103662:	0f 83 c8 00 00 00    	jae    103730 <__umoddi3+0x130>
  103668:	89 c8                	mov    %ecx,%eax
  10366a:	83 c4 1c             	add    $0x1c,%esp
  10366d:	5b                   	pop    %ebx
  10366e:	5e                   	pop    %esi
  10366f:	5f                   	pop    %edi
  103670:	5d                   	pop    %ebp
  103671:	c3                   	ret
  103672:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  103678:	89 f9                	mov    %edi,%ecx
  10367a:	85 ff                	test   %edi,%edi
  10367c:	75 0b                	jne    103689 <__umoddi3+0x89>
  10367e:	b8 01 00 00 00       	mov    $0x1,%eax
  103683:	31 d2                	xor    %edx,%edx
  103685:	f7 f7                	div    %edi
  103687:	89 c1                	mov    %eax,%ecx
  103689:	89 d8                	mov    %ebx,%eax
  10368b:	31 d2                	xor    %edx,%edx
  10368d:	f7 f1                	div    %ecx
  10368f:	89 f0                	mov    %esi,%eax
  103691:	f7 f1                	div    %ecx
  103693:	89 d0                	mov    %edx,%eax
  103695:	31 d2                	xor    %edx,%edx
  103697:	eb 94                	jmp    10362d <__umoddi3+0x2d>
  103699:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  1036a0:	89 e9                	mov    %ebp,%ecx
  1036a2:	ba 20 00 00 00       	mov    $0x20,%edx
  1036a7:	29 ea                	sub    %ebp,%edx
  1036a9:	d3 e0                	shl    %cl,%eax
  1036ab:	89 44 24 08          	mov    %eax,0x8(%esp)
  1036af:	89 d1                	mov    %edx,%ecx
  1036b1:	89 f8                	mov    %edi,%eax
  1036b3:	d3 e8                	shr    %cl,%eax
  1036b5:	89 54 24 04          	mov    %edx,0x4(%esp)
  1036b9:	8b 54 24 04          	mov    0x4(%esp),%edx
  1036bd:	89 c1                	mov    %eax,%ecx
  1036bf:	8b 44 24 08          	mov    0x8(%esp),%eax
  1036c3:	09 c1                	or     %eax,%ecx
  1036c5:	89 d8                	mov    %ebx,%eax
  1036c7:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  1036cb:	89 e9                	mov    %ebp,%ecx
  1036cd:	d3 e7                	shl    %cl,%edi
  1036cf:	89 d1                	mov    %edx,%ecx
  1036d1:	d3 e8                	shr    %cl,%eax
  1036d3:	89 e9                	mov    %ebp,%ecx
  1036d5:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  1036d9:	d3 e3                	shl    %cl,%ebx
  1036db:	89 c7                	mov    %eax,%edi
  1036dd:	89 d1                	mov    %edx,%ecx
  1036df:	89 f0                	mov    %esi,%eax
  1036e1:	d3 e8                	shr    %cl,%eax
  1036e3:	89 fa                	mov    %edi,%edx
  1036e5:	89 e9                	mov    %ebp,%ecx
  1036e7:	09 d8                	or     %ebx,%eax
  1036e9:	d3 e6                	shl    %cl,%esi
  1036eb:	f7 74 24 08          	divl   0x8(%esp)
  1036ef:	89 d3                	mov    %edx,%ebx
  1036f1:	f7 64 24 0c          	mull   0xc(%esp)
  1036f5:	89 c7                	mov    %eax,%edi
  1036f7:	89 d1                	mov    %edx,%ecx
  1036f9:	39 d3                	cmp    %edx,%ebx
  1036fb:	72 06                	jb     103703 <__umoddi3+0x103>
  1036fd:	75 10                	jne    10370f <__umoddi3+0x10f>
  1036ff:	39 c6                	cmp    %eax,%esi
  103701:	73 0c                	jae    10370f <__umoddi3+0x10f>
  103703:	2b 44 24 0c          	sub    0xc(%esp),%eax
  103707:	1b 54 24 08          	sbb    0x8(%esp),%edx
  10370b:	89 d1                	mov    %edx,%ecx
  10370d:	89 c7                	mov    %eax,%edi
  10370f:	89 f2                	mov    %esi,%edx
  103711:	29 fa                	sub    %edi,%edx
  103713:	19 cb                	sbb    %ecx,%ebx
  103715:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  10371a:	89 d8                	mov    %ebx,%eax
  10371c:	d3 e0                	shl    %cl,%eax
  10371e:	89 e9                	mov    %ebp,%ecx
  103720:	d3 ea                	shr    %cl,%edx
  103722:	d3 eb                	shr    %cl,%ebx
  103724:	09 d0                	or     %edx,%eax
  103726:	89 da                	mov    %ebx,%edx
  ...
  10372e:	5d                   	pop    %ebp
  10372f:	c3                   	ret
  103730:	89 da                	mov    %ebx,%edx
  103732:	89 f1                	mov    %esi,%ecx
  103734:	29 f9                	sub    %edi,%ecx
  103736:	19 c2                	sbb    %eax,%edx
  103738:	89 c8                	mov    %ecx,%eax
  10373a:	e9 2b ff ff ff       	jmp    10366a <__umoddi3+0x6a>
